...
from navsim.common.dataclasses import PDMResults, PDMResults_Pairwise, Trajectory
...
def pdm_score_pairwise(
    ...
    at_fault_collision_tracked_token = scorer._collision_tracked_tokens[pred_idx]
    collision_time_idcs = scorer._collision_time_idcs[pred_idx]
    drivable_area_compliance_per_waypoint = scorer._drivable_area_violations[pred_idx]

    score = scores[pred_idx]

    return PDMResults_Pairwise(
        no_at_fault_collisions,
        drivable_area_compliance,
        driving_direction_compliance,
        ego_progress,
        ...
        comfort,
        score,
        at_fault_collision_tracked_token,
        collision_time_idcs,
        drivable_area_compliance_per_waypoint
    )
