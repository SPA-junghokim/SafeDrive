"""Deformable decoder for detection, adapted from BEVFormer / OpenMMLab."""
# ---------------------------------------------
...
#                                       TRANSFORMER_LAYER_SEQUENCE, TRANSFORMER_LAYER, POSITIONAL_ENCODING)
    ...
    def forward(self,
        ...
        for lid, layer in enumerate(self.layers):
            ...
            if reg_branches is not None:
                ...
                # new_reference_points[..., 2:3] = tmp[..., 2:3] + inverse_sigmoid(reference_points[..., 2:3])
...
class CustomMSDeformableAttention(BaseModule):
    ...
    def forward(self,
        ...
        sampling_offsets = self.sampling_offsets(query).view(
            bs, num_query, self.num_heads, self.num_levels, self.num_points, 2) # torch.Size([26, 30, 8, 1, 4, 2])
        ...
        attention_weights = attention_weights.view(bs, num_query,
                                                   self.num_heads,
                                                   self.num_levels,
                                                   self.num_points) # torch.Size([26, 30, 8, 1, 4])
