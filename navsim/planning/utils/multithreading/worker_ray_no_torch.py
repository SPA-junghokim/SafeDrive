...
from nuplan.planning.utils.multithreading import ray_execution
...
if os.environ.get("SAFEDRIVE_RAY_TQDM", "0") != "1":
    _orig_tqdm = ray_execution.tqdm
    def _quiet_tqdm(*args, **kwargs):
        kwargs.setdefault("disable", True)
        return _orig_tqdm(*args, **kwargs)
    ray_execution.tqdm = _quiet_tqdm
